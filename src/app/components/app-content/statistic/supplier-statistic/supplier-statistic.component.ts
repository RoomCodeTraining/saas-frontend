...
@Component({
  selector: 'app-supplier-statistic',
  templateUrl: './supplier-statistic.component.html',
  styleUrls: ['./supplier-statistic.component.css']
})
export class SupplierStatisticComponent implements OnInit {
  ...
  getEntityStatistics(item:any){
    this.SpinnerService.show();
    this.appService.getSupplierStatistics(item.entity_id,this.entity_product_id,this.campaign_id,this.date_from,this.date_to).subscribe((data: any) => {
