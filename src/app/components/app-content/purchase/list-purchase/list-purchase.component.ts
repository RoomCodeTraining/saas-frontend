...
export class ListPurchaseComponent implements OnInit {
  ...
  getItems(){
    this.appService.getPurchase(this.current_page).subscribe((data: any) => {
  ...
  search(){
    this.SpinnerService.show();
    this.appService.getPurchaseSearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
        this.appService.getPurchasePaginate(this.current_page).subscribe((data: any) => {
          this.listItem = data.data;
