...
@Component({
  selector: 'app-detail-delegate',
  templateUrl: './detail-delegate.component.html',
  styleUrls: ['./detail-delegate.component.css']
})
export class DetailDelegateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.entity = localStorage.getItem("DELEGATE_DATA");
