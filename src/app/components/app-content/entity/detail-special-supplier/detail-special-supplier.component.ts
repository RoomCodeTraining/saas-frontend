...
export class DetailSpecialSupplierComponent implements OnInit {
  ...
  getEntityStatistics(){
    this.appService.getSpecialSupplierStatistics(this.entity.id,this.itemSelected.entity_product.id,this.itemSelected.campaign.id,this.date_from,this.date_to).subscribe((data: any) => {
