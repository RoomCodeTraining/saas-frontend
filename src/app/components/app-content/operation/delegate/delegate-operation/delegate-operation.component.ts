...
@Component({
  selector: 'app-delegate-operation',
  templateUrl: './delegate-operation.component.html',
  styleUrls: ['./delegate-operation.component.css']
})
export class DelegateOperationComponent implements OnInit {
  ...
  getItems(){
    this.appService.getAllDelegateOperation(this.current_page).subscribe((data: any) => {
  ...
  search(){
    this.SpinnerService.show();
    this.appService.getAllDelegateOperationSearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
        this.appService.getAllDelegateOperationPaginate(this.current_page).subscribe((data: any) => {
          this.listItem = data.data;
