...
@Component({
  selector: 'app-special-supplier-operation',
  templateUrl: './special-supplier-operation.component.html',
  styleUrls: ['./special-supplier-operation.component.css']
})
export class SpecialSupplierOperationComponent implements OnInit {
  ...
  getItems(){
    this.appService.getAllSpecialSupplierOperation(this.current_page).subscribe((data: any) => {
  ...
  search(){
    this.SpinnerService.show();
    this.appService.getAllSpecialSupplierOperationSearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
        this.appService.getAllSpecialSupplierOperationPaginate(this.current_page).subscribe((data: any) => {
          this.listItem = data.data;
