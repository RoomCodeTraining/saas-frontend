...
export class ListPriceComponent implements OnInit {
  ...
  getItems(){
    this.appService.getPrice(this.current_page).subscribe((data: any) => {
  ...
  search(){
    this.SpinnerService.show();
    this.appService.getPriceSearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
        this.appService.getPricePaginate(this.current_page).subscribe((data: any) => {
          this.listItem = data.data;
