...
@Component({
  selector: 'app-list-warehouse-delivery',
  templateUrl: './list-warehouse-delivery.component.html',
  styleUrls: ['./list-warehouse-delivery.component.css']
})
export class ListWarehouseDeliveryComponent implements OnInit {
  ...
  getItems(){
    this.appService.getWarehouseDelivery(this.current_page).subscribe((data: any) => {
  ...
  search(){
    this.SpinnerService.show();
    this.appService.getWarehouseDeliverySearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
      this.appService.getWarehouseDeliveryPaginate(this.current_page).subscribe((data: any) => {
        this.listItem = data.data;
