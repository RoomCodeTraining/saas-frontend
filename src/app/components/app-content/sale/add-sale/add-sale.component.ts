...
export class AddSaleComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formGroup = new FormGroup({
      children_id: new FormControl('', [Validators.required]),
  ...
  getAllClient(){
    this.appService.getAllClient(this.type).subscribe((data: any) => {
  ...
  save(){
    ...
    if(this.formGroup.invalid){
      ...
      this.appService.addSale(requestData).subscribe(res => {
        this.message = res;
