...
export class ListSaleComponent implements OnInit {
  ...
  getItems(){
    this.appService.getSale(this.current_page).subscribe((data: any) => {
  ...
  search(){
    this.SpinnerService.show();
    this.appService.getSaleSearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
        this.appService.getSalePaginate(this.current_page).subscribe((data: any) => {
          this.listItem = data.data;
  ...
  cancel(){
    ...
    this.appService.cancelSale(this.itemSelected.id,requestData).subscribe(res => {
      this.message = res;
      if(this.message.success == false){
        this.submit = false;
        this.error_message = this.message.message;
