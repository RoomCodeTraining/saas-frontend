...
export class LoginComponent implements OnInit {
  ...
  resendOtpCode() {
    ...
    formData.append("code",this.otp_id);

    this.Jarwis.resendOtp("").subscribe((res: any) => {
      this.message = res;
      if(this.message.success == false){
        this.error_exist = true;
        this.error_message = this.message.message;
  ...
  submitOtpCode() {
    this.submit_otp_code = true;

    const formData:any = new FormData();

    //formData.append("otp_id",this.otp_id);
    formData.append("code",this.otp_code);

    this.Jarwis.sendOtp(formData).subscribe((res: any) => {
      this.submit_otp_code = false;
      this.message = res;
      if(this.message.success == false){
        this.error_exist = true;
  ...
  // handleResponse() {
  //   this.appService.getUserPeopleProfile().subscribe((data: any) => {
