...
export class SetPasswordComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      const encodedParam = params['action']; // Replace 'your_param_name' with your actual parameter name
      if (encodedParam) {
        this.action = decodeURIComponent(encodedParam);
        //console.log('Decoded Param:', this.action);
  ...
  onSubmit() {
    ...
    // this.Jarwis.setPassword(this.action,formData).subscribe(res => {
